<<<<<<< HEAD:assets/src/data/content/model/nodes/list/ListsCmd.tsx
...
import { handleIndent, handleOutdent } from 'data/content/model/nodes/list/lists';
=======
...
import guid from 'utils/guid';
>>>>>>> fix-toolbar:assets/src/components/editing/nodes/list/listActions.ts
